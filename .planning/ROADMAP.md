...
- [ ] **Phase 1: Project Setup** - Xcode project scaffolding and Firebase backend configuration
...
- [ ] **Phase 4: QR Check-in Flow** - QR code generation and drinker check-in via scan
...
**Goal**: Project foundation exists with working Firebase connection and basic SwiftUI navigation
...
**Success Criteria** (what must be TRUE):
  ...
  5. App includes a visual glass type reference guide accessible from collection screen
**Plans**: TBD
...
**Success Criteria** (what must be TRUE):
  ...
  3. After selecting a beer, app displays beer info (name, style, ABV)
**Plans**: TBD
